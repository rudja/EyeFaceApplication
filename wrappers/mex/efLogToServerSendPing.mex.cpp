...
////////////////////////////////////////////////////////////////////
///                                                              ///
///    MEX source wrapper of efLogToServerSendPing().            ///
///   --------------------------------------------------------   ///
///                                                              ///
    ...
    int nrhs, const mxArray * prhs[])
{
    ...
    if (nrhs != 2 || nlhs != 0)
    {
        mexErrMsgTxt("Unsupported number of arguments!\n[] = efLogToServerSendPing(eyeface_state, eyeface_functions);\n");
    }
    ...
    EfBool success = eyeface_functions->fcnEfLogToServerSendPing(eyeface_state);
    
    if (success != EF_TRUE)
    {
        mexErrMsgTxt("EyeFace SDK function efLogToServerSendPing failed!\n");
    }
}
