...
////////////////////////////////////////////////////////////////////
///                                                              ///
///    MEX source wrapper of efLogToFileWriteTrackInfo().        ///
///   --------------------------------------------------------   ///
///                                                              ///
    ...
    int nrhs, const mxArray * prhs[])
{
    ...
    if (nrhs != 2 || nlhs != 0)
    {
        mexErrMsgTxt("Unsupported number of arguments!\n[] = efLogToFileWriteTrackInfo(eyeface_state, eyeface_functions);\n");
    }
    ...
    EfBool success = eyeface_functions->fcnEfLogToFileWriteTrackInfo(eyeface_state);
    
    if (success != EF_TRUE)
    {
        mexErrMsgTxt("EyeFace SDK function efLogToFileWriteTrackInfo failed!\n");
    }
}
